...
*/
  ...
  #define SPEED_COEFFICIENT       3500   // 1.0f [-] fixdt(1,16,14) higher value == stronger. [0, 65535] = [-2.0 - 2.0]. In this case 16384 = 1.0 * 2^14, 3000 kommt den Berg nur schwer hoch, 6000 stürmt los
...
// ############################ VARIANT_HOVERCAR SETTINGS ############################
  ...
  // #define CONTROL_PWM_RIGHT       0         // use ADC as input. Number indicates priority for dual-input. Disable CONTROL_SERIAL_USART2, FEEDBACK_SERIAL_USART2, DEBUG_SERIAL_USART2!
  #define CONTROL_PWM_RIGHT   0         // use RC PWM as input on the RIGHT cable.  Number indicates priority for dual-input. Disable DEBUG_SERIAL_USART3!
  ...
  #define PRI_INPUT2              2,  -800, 0,  700, 100  // Pedal Accel        TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
...
*/
  ...
  #define PRI_INPUT2          3, -1000, 0, 1000, 150    // Active.   TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section. bis jetzt fehlte das Minuszeichen
